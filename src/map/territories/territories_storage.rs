...
impl TerritoriesStorage {
    ...
    pub fn insert(&mut self, coordinate: Coordinate, territory_id: TerritoryID) {
        ...
        self.by_territory_id
            ...
            .unwrap()
            .insert(coordinate);
        self.by_coordinate.insert(coordinate, territory_id);
    }
    ...
    pub fn remove_territory(&mut self, territory_id: &TerritoryID) {
